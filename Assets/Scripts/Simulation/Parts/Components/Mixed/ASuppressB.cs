internal class ASuppressB : Component
{
	...
	public ASuppressB(Simulation simulation, Ship ship, World world, DigitalWire aInput, AnalogueWire bInput,
	                     AnalogueWire resultOutput) : base(simulation, ship, world)
	{
